  ...
  ionViewWillEnter() {
    ...
    this.comment = this.replaceParametersProvider.replace(
      this.translate.instant(
        "{{appName}} depends on Bitcore Wallet Service (BWS) for blockchain information, networking. The default configuration points to https://tbws.trias.one (Trias's public BWS instance)."
      ),
      { appName }
    );
